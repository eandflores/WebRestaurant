<h3>Disminuir Stock <?php echo $Elemento[0]->ing_nombre." - Actualmente ".$Elemento[0]->ing_stock." ".$Elemento[0]->ing_medida ?>
</h3>
...
<form class="form-horizontal well" method="post">
    <fieldset>
        ...
        <div class="control-group">
            <label class="control-label" for="inputStock">Cantidad a Disminuir</label>
            <div class="controls">
