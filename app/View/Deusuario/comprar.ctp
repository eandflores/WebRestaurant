...
<form method="post" class="form-horizontal well" action="/furaibar/Deusuario/pedidos/">
    ...
    <div class="form-actions">
	        ...
	        <input class="btn" type="reset" onclick="window.location='/furaibar/Deusuario'" value="Cancelar">
        </div>
</form>